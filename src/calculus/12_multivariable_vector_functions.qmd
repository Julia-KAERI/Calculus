...
::: {#thm-CAL_derivative_of_inverse_function}
...
$$
G(F(X))=X \implies G'(Y)F'(X)=I \implies G'(Y)=\left(F'(X)\right)^{-1}. \square
$$
...
::: {#thm-CAL_inverse_function_Theorem}
...
::: {#thm-CAL_implicit_functino_theorem}
